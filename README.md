...
- **Double-Fetch (subject1 + subject2)**: System automatycznie odpytuje KSeF o oba kierunki jednocześnie — Twoją sprzedaż oraz Twoje zakupy (używając ujednoliconego klucza `invoicingDate` dla maksymalnej skuteczności).
